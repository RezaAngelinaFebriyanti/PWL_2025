        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <small class="d-block text-muted">Format: TRXXXX diikuti angka, contoh: TRX001</small>
                    <input type="text" name="penjualan_kode" class="form-control" value="TRX" required>
